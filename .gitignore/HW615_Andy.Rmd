...
```{r}
cover_url= 'https://raw.githubusercontent.com/ydmaolover/MA-615/master/image%20of%20a%20book.jpg'
...
Our goal is to produce a table that shows that $P(T = n | k = 1, 2, ..., 49)$. In order to obtain this probablity, first we need to know $pk$ for each $k$.
